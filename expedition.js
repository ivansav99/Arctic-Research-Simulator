(() => {
  ...
  const VESSEL_IMAGES = {
    coastal:'assets/vessels/base-vessel.png',
    global:(window.AR_VISUAL_ASSETS&&window.AR_VISUAL_ASSETS.vessels&&window.AR_VISUAL_ASSETS.vessels.global)||'assets/vessels/noaa-rv-brown.webp',
    icebreaker:(window.AR_VISUAL_ASSETS&&window.AR_VISUAL_ASSETS.vessels&&window.AR_VISUAL_ASSETS.vessels.icebreaker)||'assets/vessels/base-vessel.png',
    nuclear:(window.AR_VISUAL_ASSETS&&window.AR_VISUAL_ASSETS.vessels&&window.AR_VISUAL_ASSETS.vessels.nuclear)||'assets/vessels/base-vessel.png'
  };
  const VESSELS = {
    fishing: {
