(() => {
  ...
  const TEMPLATES = [
    ...
    mission({id:'postdoc-acoustic-inversion',postdocOpportunity:true,title:'Coupled Acoustic Scattering & Plankton Community Inversion',shortTitle:'ACOUSTIC INVERSION',specialties:['fisheries','plankton'],equipment:['fish-acoustics','plankton-winch'],transect:true,stationCounts:{coastal:4,global:6,icebreaker:8,nuclear:10},stationSpacingKm:14,data:62,reward:82000,supplies:17,workHours:84,media:MEDIA.heavyMultinet,description:'Combine multi-frequency acoustic backscatter with depth-resolved net samples to invert scattering layers into biological size and community structure.',steps:['Calibrate the acoustic frequencies','Map vertically migrating scattering layers','Collect depth-matched net samples','Fit taxon-specific scattering models','Invert the section for community structure']}),
